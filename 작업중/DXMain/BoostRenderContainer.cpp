#include "stdafx.h"
#include "BoostRenderContainer.h"

//---------------------------dxobject---------------------------------
bool CBoostRenderContainer::Begin() {


	return true;
}
bool CBoostRenderContainer::End() {
...
//--------------------------container---------------------------------
void CBoostRenderContainer::UpdateShaderState() {
...
void CBoostRenderContainer::SetShaderState() {
	m_pMesh->SetShaderState();
	m_pShader->SetShaderState();
}
void CBoostRenderContainer::RenderExcute() {
	m_pMesh->RenderExcute(m_nInstance);
}

void CBoostRenderContainer::SetnullptrShaderState() {
	m_pMesh->SetnullptrShaderState();
	m_pShader->SetnullptrShaderState();
}

CBoostRenderContainer::CBoostRenderContainer(shared_ptr<CCamera> pCamera, ID3D11Device* pd3dDevice, ID3D11DeviceContext* pd3dDeviceContext) : CRenderContainer(pCamera, pd3dDevice, pd3dDeviceContext) {

}
CBoostRenderContainer::~CBoostRenderContainer() {
