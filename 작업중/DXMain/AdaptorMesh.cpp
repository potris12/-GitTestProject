...
bool CAdaptorMesh::CreateVertexBuffer() {
...
bool CAdaptorMesh::CreateIndexBuffer() {
...
CAdaptorMesh::CAdaptorMesh(ID3D11Device* pd3dDevice, ID3D11DeviceContext* pd3dDeviceContext) : CMesh(pd3dDevice, pd3dDeviceContext) {

}
CAdaptorMesh::~CAdaptorMesh() {
