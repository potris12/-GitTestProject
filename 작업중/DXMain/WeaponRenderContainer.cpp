#include "stdafx.h"
#include "WeaponRenderContainer.h"

//---------------------------dxobject---------------------------------
bool CWeaponRenderContainer::Begin() {
	

	return true;
}
bool CWeaponRenderContainer::End() {
...
//--------------------------container---------------------------------
void CWeaponRenderContainer::UpdateShaderState() {
...
void CWeaponRenderContainer::SetShaderState() {
	m_pMesh->SetShaderState();
	m_pShader->SetShaderState();
}
void CWeaponRenderContainer::RenderExcute() {
	m_pMesh->RenderExcute(m_nInstance);
}

void CWeaponRenderContainer::SetnullptrShaderState() {
	m_pMesh->SetnullptrShaderState();
	m_pShader->SetnullptrShaderState();
}

CWeaponRenderContainer::CWeaponRenderContainer(shared_ptr<CCamera> pCamera, ID3D11Device* pd3dDevice, ID3D11DeviceContext* pd3dDeviceContext) : CRenderContainer(pCamera, pd3dDevice, pd3dDeviceContext) {

}
CWeaponRenderContainer::~CWeaponRenderContainer() {
