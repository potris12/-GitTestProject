...
bool CWeaponMesh::CreateVertexBuffer() {
	...
	for (int i = 0; i < 8; i++) pxmf4Colors[i] = XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f);
...
bool CWeaponMesh::CreateIndexBuffer() {
...
CWeaponMesh::CWeaponMesh(ID3D11Device* pd3dDevice, ID3D11DeviceContext* pd3dDeviceContext) : CMesh(pd3dDevice, pd3dDeviceContext) {
